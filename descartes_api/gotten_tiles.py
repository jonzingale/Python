...
import sys
sys.path.append('/Users/conor/anaconda3/envs/descartes/Lib/site-packages') # yay windows %matplotlib inline
...
ax.add_geometries([shapely.geometry.shape(ctown['geometry'])],
                   lonlat_crs)
